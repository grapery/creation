                    ...
                    <div className="max-w-6xl mx-auto">
                        <div className="grid md:grid-cols-4 gap-8 mb-8">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm text-muted-foreground">
                                    <li><Link href="/settings/about" className="hover:text-foreground transition-colors">关于我们</Link></li>
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm text-muted-foreground">
                                    <li><Link href="/settings/terms" className="hover:text-foreground transition-colors">用户协议</Link></li>
                                    <li><Link href="/settings/privacy" className="hover:text-foreground transition-colors">隐私政策</Link></li>
                                    <li><Link href="/settings/about#contact" className="hover:text-foreground transition-colors">联系我们</Link></li>
                                </ul>
                            </div>
                        </div>
