...
export async function POST(
    ...
    try {
        ...
        const backendUrl = `${BACKEND_URL}/api/characters/${characterId}/chat`;
        ...
        if (!response.ok) {
            let errorMessage = 'Failed to send message to character';
            try {
        ...
        console.error('[API /characters/[id]/chat] Exception caught:', error);
