...
export async function GET(
    ...
    try {
        ...
        console.error('[API /stories/[id]/contributors] Exception caught:', error);
...
export async function POST(
    ...
    try {
        ...
        if (!response.ok) {
            let errorMessage = 'Failed to invite contributor';
            try {
                const errorData = await response.json();
                errorMessage = errorData.message || errorData.msg || errorMessage;
            } catch {}
        ...
        console.error('[API /stories/[id]/contributors] POST Exception caught:', error);
