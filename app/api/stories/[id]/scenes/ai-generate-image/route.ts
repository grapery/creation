...
export async function POST(
    ...
    try {
        ...
        // Get query parameters for optional sceneId
        ...
        if (!response.ok) {
            let errorMessage = 'Failed to generate AI scene image';
            try {
        ...
        console.error('[API /stories/[id]/scenes/ai-generate-image] Exception caught:', error);
