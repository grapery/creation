...
export async function GET(
    ...
    try {
        ...
        const backendUrl = `${BACKEND_URL}/api/groups/${groupId}/stories${queryString ? `?${queryString}` : ''}`;
        ...
        if (!response.ok) {
            let errorMessage = 'Failed to fetch group stories';
            try {
        ...
        console.error('[API /groups/[id]/stories] Exception caught:', error);
