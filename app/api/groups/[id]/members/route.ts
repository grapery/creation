...
export async function GET(
    ...
    try {
        ...
        const backendUrl = `${BACKEND_URL}/api/groups/${groupId}/members${queryString ? `?${queryString}` : ''}`;
        ...
        console.error('[API /groups/[id]/members] Exception caught:', error);
...
export async function POST(
    ...
    try {
        ...
        const backendUrl = `${BACKEND_URL}/api/groups/${groupId}/members/invite`;
        ...
        console.error('[API /groups/[id]/members/invite] Exception caught:', error);
