...
export async function GET(
    ...
    try {
        ...
        const backendUrl = `${BACKEND_URL}/api/storyboards/${storyboardId}`;
        ...
        if (!response.ok) {
            let errorMessage = 'Failed to fetch storyboard';
            try {
        ...
        console.error('[API /storyboards/[id]] Exception caught:', error);
