...
欢迎使用 Grapery 平台！感谢您选择我们的服务。在使用我们的服务之前，请仔细阅读并理解本服务协议（以下简称"协议"）。通过访问或使用 Grapery 平台，即表示您同意接受本协议的所有条款和条件。
...
Grapery 是一个 **AI 驱动的故事创作协作平台**，提供以下主要服务：
...
Grapery 平台的所有内容、功能和设计，包括但不限于文字、图形、标识、图像、软件、代码等，均受知识产权法保护，归我们或我们的许可方所有。
...
Grapery 平台按"按原样"和"按可用"基础提供服务，不提供任何明示或暗示的保证，包括但不限于：
